This repository contains a simple script for calcualting homography between two images and the moving image over the static image using points selected by mouse.
